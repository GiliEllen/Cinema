...
function App() {
  ...
  return (
    <BrowserRouter>
      <NavBar films={films} filmsToDisp={filmsToDisp} setFilmsToDisp={setFilmsToDisp}/>
      <Routes>
        <Route path="/" element={<Home films={films} filmsToDisp={filmsToDisp}/>} />
        <Route path="/admin" element={<Admin films={films} filmsToDisp={filmsToDisp}/>} />
